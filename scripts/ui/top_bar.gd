...
func initialize(stats: CharacterStats) -> void:
	...
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/铁心药水.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/鲜血药水.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/赌徒特酿.tres")))
	tween.tween_interval(1.0)
